...
;;
ch4)
/usr/local/bin/livestreamer https://sdo.gsfc.nasa.gov/data/latest48.php?q=0171 best --player omxplayer --fifo --player-args "--layer 1 --win '0 0 800 480' --timeout 25 --live {filename}"
;;
esac
done
