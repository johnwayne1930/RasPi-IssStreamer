...
/usr/local/bin/livestreamer http://ustream.tv/channel/iss-hdev-payload best --player omxplayer --fifo --player-args "--layer 1000 --win '0 0 800 480' --threshold .01 --video_fifo .01 --timeout 20 --live {filename}"
else
/usr/local/bin/livestreamer http://ustream.tv/channel/live-iss-stream best --player omxplayer --fifo  --player-args "--layer 1000 --win '0 0 800 480' --threshold .01 --video_fifo .01 --timeout 20 --live {filename}"
fi
;;
ch1)
