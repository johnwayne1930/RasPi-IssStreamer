...
# /usr/local/bin/livestreamer http://192.1.168.23:8081 worst --player omxplayer --fifo --player-args "--blank --win '400 0 800 240' --timeout 25 --live {filename}"
omxplayer --win "400 0 800 240" http://192.1.168.23:8081
;;
esac
done
